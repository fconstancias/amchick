...
```{r}
ps = "data/raw/metabarcoding/ps_silva_dada2_humanonly_phylo_meta.RDS"
...
ps %>% 
  ...
  subset_samples(Enriched == "not_enriched")  -> physeq
...
alpha_df %>%
  plot_alphas(measure = measures_alpha,
              ...
              colour_group = "Enriched",
              fill_group = "Enriched",
              shape_group = "Enriched",
              facet_group = "Reactor_Treatment",
              test_group = "Reactor_Treatment",
              test_group_2 = "Enriched") -> alpha_out 
```
...
alpha_out$plot$data %>%
  dplyr::filter(Enriched == "not_enriched") %>%
  plot_time(measure = measures_alpha,
            x = "Day_of_inoculum",
            facet = c("alphadiversiy ~ ."),
            fill = "Day_of_treatment",
